...
import ollama
from tqdm.notebook import tqdm # Updated for better Colab UI
...
INPUT_PATH       = "/content/training_data_reclassified.json"
OUTPUT_PATH      = "/content/training_data_topped_up.json"
PARTIAL_PATH     = "/content/training_data_topup_partial.json"
...
def main():
    try:
        ...
        if not any(MODEL_ID in m for m in available):
            print(f"\n❌ Model '{MODEL_ID}' not found. Did you run the setup cell?")
            return
